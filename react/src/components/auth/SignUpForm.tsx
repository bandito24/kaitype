    ...
    return (
        <form onSubmit={(e)=>onSubmit(e)}>
            <div className="grid gap-2">
                ...
                <Input ref={usernameRef} className="mb-4" id="username" type="text" placeholder="Username"/>
            </div>
            <div className="grid gap-2">
                <Label htmlFor="email">Email</Label>
                <Input ref={emailRef} className="mb-4" id="email" type="email" placeholder="email@example.com"/>
            </div>
            <div className="grid gap-2">
                <Label htmlFor="password">Enter Password</Label>
                <Input ref={passwordRef} className="mb-4" id="password" type="password"/>
            </div>
            <div className="grid gap-2">
                <Label htmlFor="confirm_password">Confirm Password</Label>
                <Input ref={confirmPasswordRef} className="mb-6" id="confirm_password" type="password"/>
            </div>
            <CardFooter>
